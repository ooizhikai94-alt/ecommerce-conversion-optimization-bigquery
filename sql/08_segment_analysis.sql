...
--
-- Purpose:
--   Identify specific device, country, and traffic-source
--   segments with meaningful funnel performance differences.
--
-- Funnel stages:
...
--   Results from small segments should be interpreted cautiously.
-- ============================================================
